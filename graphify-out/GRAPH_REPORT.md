# Graph Report - expo-clean-arch  (2026-06-01)

## Corpus Check
- 59 files · ~27,536 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 445 nodes · 547 edges · 39 communities (29 shown, 10 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 29 edges (avg confidence: 0.86)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `b15da1b2`
...
2. `post` - 13 edges
3. `Post` - 12 edges
4. `Architecture` - 12 edges
5. `useAppTheme()` - 10 edges
6. `Struc POC Codebase Documentation` - 10 edges
7. `settings` - 9 edges
8. `settings` - 9 edges
9. `Clean Architecture (Four Layers)` - 9 edges
10. `Stale Architecture Documentation (React Query + Axios + class-based)` - 9 edges
...
Cohesion: 0.08
Nodes (25): RootContent(), resources, back(), navigateTo(), resetTo(), PostDetailParams, PostDetailProps, PostDetailScreen() (+17 more)

### Community 2 - "Package Dependencies"
Cohesion: 0.05
Nodes (43): dependencies, expo, expo-constants, expo-haptics, expo-image, expo-linking, expo-localization, expo-network (+35 more)
...
Cohesion: 0.09
Nodes (20): postsApi, PostCard(), PostCardProps, useStyles, Post, CreatePostRequestDTO, PostDTO, PostModel (+12 more)
...
Cohesion: 0.06
Nodes (30): CustomTypeOptions, detail, loading, notFound, title, post, bodyPlaceholder, cancelEdit (+22 more)

### Community 7 - "Build & Dev Tooling"
Cohesion: 0.29
Nodes (7): devDependencies, @babel/plugin-proposal-decorators, babel-plugin-transform-typescript-metadata, eslint, eslint-config-expo, @types/react, typescript

### Community 8 - "Screens & Components"
Cohesion: 0.05
Nodes (40): app/index.tsx, app/_layout.tsx, 🏗️ Architecture Overview, 🔥 Best Practices, Core, ⚙️ Core Layer, data/api/authApi.ts (RTK Query), 🔄 Data Flow (+32 more)

### Community 9 - "Post UI Strings"
Cohesion: 0.11
Nodes (18): 1. Project Overview, 2. Tech Stack, 3. Directory Structure, 4. Architecture and Dependencies, 5.1 App Startup, 5.2 Data Fetch Flow (`GET /posts`), 5.3 Create/Update/Delete Flow, 5.4 Error/Auth/Network Handling (+10 more)

### Community 10 - "TypeScript Config"
Cohesion: 0.15
Nodes (12): compilerOptions, baseUrl, emitDecoratorMetadata, experimentalDecorators, jsx, paths, skipLibCheck, strict (+4 more)
...
Cohesion: 0.12
Nodes (14): Architecture, Commands, Config, Data/model transformation, DI, Domain layer, i18n, Notes (+6 more)

## Knowledge Gaps
- **219 isolated node(s):** `recommendations`, `source.fixAll`, `source.organizeImports`, `source.sortMembers`, `i18n-ally.localesPaths` (+214 more)
...
- **Should `Config, Errors & Constants` be split into smaller, more focused modules?**
